...
def func():
    print(username.get())
    print(password.get())
    print("Not a robot for sure:", check.get())


login = tkinter.Button(main_window, text='Login', command=func)
...
check_box = tkinter.Checkbutton(main_window, text="I'm not a robot", variable=check)
